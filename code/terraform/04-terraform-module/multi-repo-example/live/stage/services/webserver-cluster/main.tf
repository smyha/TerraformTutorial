...
module "webserver_cluster" {
  ...
  # Replaced to my own repo (github.com/smyha/TerraformTutorial)
  source = "github.com/smyha/TerraformTutorial//code/terraform/04-terraform-module/module-example/modules/services/webserver-cluster"
